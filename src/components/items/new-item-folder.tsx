/**
 * NewItemFolder component
 * This component is a modal to create a new folder in the item creating process
 */
                    ...
                    <div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
                        ...
                        >
                            <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6'>
                                ...
                                {/* Combobox to select the parent folder */}
                                        ...
                                        <Combobox.Options className='absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm'>
                                            {[rootFolder, ...rootFolders].map((folder) => (
                                                ...
                                                >
                                                    {({ selected, active }) => (
                                                        <>
                                                            <span className={`block truncate ${selected && 'font-semibold'}`}>{folder.name}</span>
                                                            {selected && (
                                                                <span
                                ...
                                {/* Buttons for cancel and add folder */}

...
const ItemView = ({ item }: ItemProps) => {
    ...
    const copySensitiveDataToClipboard = async () => {
        ...
        try {
            ...
            alert('Sensitive data copied to clipboard.');
        } catch (err) {
                ...
                <div className="space-y-12">
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="col-span-full">
                            ...
                            <p className="mt-1 text-base leading-6 text-gray-600 break-words">
                                {item.description}
                            </p>
                        </div>
                        ...
                        <div className="col-span-full">
                            ...
                            <div className="mt-1 flex max-w-xs items-center p-2 rounded-md bg-indigo-50 text-gray-900 shadow ring-1 ring-inset ring-gray-300">
                                ...
                                <span className="text-base leading-6">
                                    {item.folder?.name || 'No Folder Selected'}
                                </span>
                            </div>
                        </div>
                        ...
                        {/* Tags Display */}
                        {item.item_tags.length > 0 && (<div className="col-span-full">
